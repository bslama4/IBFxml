...
public class EWrapperImpl implements EWrapper {
	...
	//! [receivefa]
        ...
        public void goldenCross(double high)
        {
            mavgShort.addData(high);
            mavgLong.addData(high);
        ...
        public void breakOutStrat(double high)
        {
	...
	public void historicalData(int reqId, Bar bar) {
		System.out.println("HistoricalData. "+reqId+" - Date: "+bar.time()+", Open: "+bar.open()+", High: "+bar.high()+", Low: "+bar.low()+", Close: "+bar.close()+", Volume: "+bar.volume()+", Count: "+bar.count()+", WAP: "+bar.wap());
                //textArea.appendText(bar.open()+" "+bar.high()+" "+bar.low()+" "+bar.close() + "\n");
                //Strategy.add(reqId, barValues)
	...
	public void accountSummary(int reqId, String account, String tag,
		...
		System.out.println("Acct Summary. ReqId: " + reqId + ", Acct: " + account + ", Tag: " + tag + ", Value: " + value + ", Currency: " + currency);
                //textArea.appendText("Acct Summary. ReqId: " + reqId + ", Acct: " + account + ", Tag: " + tag + ", Value: " + value + ", Currency: " + currency+ "\n");
                textArea.appendText("Acct Summary " + value + "\n");
        }
	//! [accountsummary]
